        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header titulo text-center">A. Arithmetic</h2>
            </div>
             <div class="col-lg-4 col-sm-4 text-center">
                <img class="img-rounded img-responsive img-center" src="http://sumaventas.com.mx/study/img/preparatoria1/a-numeros.png" alt="Àritmetica">
