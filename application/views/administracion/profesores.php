  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="frmNuevoProfesor" method="post" action="#">
            <input type="hidden" name="id_nuevoProfesor" id="id_nuevoProfesor">
          <div class="row form-group">
              <div class="col-lg-12">
                <label class="txt-editar">Nombre:</label>
                <input id="nuevoNombre" type="text" name="nuevoNombre" class="input-editar" autofocus required>
              </div>
            </div>
            <div class="row form-group">
              <div class="col-lg-12">
                <label class="txt-editar">Apellidos:</label>
                <input id="nuevoApellido" type="text" name="nuevoApellido" class="input-editar" required>
              </div>
            </div>
            <div class="row form-group">
              <div class="col-lg-12">
                <label class="txt-editar">Email:</label>
                <input id="nuevoEmail" type="text" name="nuevoEmail" class="input-editar" required>
              </div>
            </div>
            <div class="row form-group">
              <div class="col-lg-12">
                <label class="txt-editar">Nivel:</label>
                <select class="nuevoNivel" name="nuevoNivel"></select>
              </div>
            </div>
            <div class="row form-group">
              <div class="col-lg-12">
                <label class="txt-editar">Contraseña:</label>
                <input id="nuevoPassword" type="password" name="nuevoPassword" class="input-editar" required>
              </div>
            </div>
            <div class="row form-group">
              <div class="col-lg-12">
                <label class="txt-editar">Confirmar Contraseña:</label>
            ...
            <div class="modal-footer">
              ...
              <button id="btnGuardarProfesor" type="button" data-dismiss="modal" class="btn btn-guardar"><i class="fa fa-check-circle-o fa-lg" aria-hidden="true"></i> Guardar</button>
            </div>
          </form>
        </div>
    </div><!-- /.modal-content -->
