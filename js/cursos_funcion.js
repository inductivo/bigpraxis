$(document).ready(function() {
	...
	function mostrarTemas(jsonData) {
		...
		for(i=0; i<datos.length;i++)
		{
				...
				html1='<div class="col-lg-4 col-sm-4 text-center cont-img" data-idtema="'+datos[i].id_temas+'">';
	...
	function mostrarMateria(materia)
	{
		...
		html4='';
		html4='<h1 id="h1-temas" class="page-header text-center titulo">'+nom_materia+'</h1>';
